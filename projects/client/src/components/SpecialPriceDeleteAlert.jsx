...
const SpecialPriceDeleteAlert = (props) => {
    return (
        <AlertDialog isOpen={props.data.isOpen} leastDestructiveRef={props.data.leastDestructiveRef} onClose={props.data.onClose}>
            <AlertDialogOverlay />
            <AlertDialogContent>
                <AlertDialogHeader fontSize='lg' fontWeight='bold'>Delete special price</AlertDialogHeader>
...
export default SpecialPriceDeleteAlert